...
const varifyEmailApplicant = async (req, res) => {
    try {
      const {  otp,password } = req.body;
        ...
        if (!generatedotp) {
          ...
          await  Applicant.findOneAndUpdate({email:req.user.email},{password:hashedPassword},{new:true})
  ...
  module.exports = varifyEmailApplicant;