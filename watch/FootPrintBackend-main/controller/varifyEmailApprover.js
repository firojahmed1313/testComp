...
const varifyEmailApprover = async (req, res) => {
    try {
      const {  otp,password } = req.body;
        ...
        if (!generatedotp) {
          ...
          await  Approver.findOneAndUpdate({email:req.user.email},{password:hashedPassword},{new:true})
  ...
  module.exports = varifyEmailApprover;