...
const ReviewProjects = () => {
  ...
  //         HOI: getAllHOI
  //           .filter((value) => value.provincial_superior_agree.agree === true)
  //           .map((project) => {
  //             return {
  ...
  //           .filter(
  //             (value) =>
  //               value.general_information.provincial_superior.agree === true
  //           )
  //           .map((project) => {
  //             return {
  ...
  //           .filter(
  //             (value) => value.mailing_list.provincial_superior.agree === true
  //           )
  //           .map((project) => {
  //             return {
  //               id: project.project_number,
              ...
              AllProjects.map((ele, key) => (
                <React.Fragment key={key}>
                  {ele.data.map((project, k) => {
                    if (
                      project.provincial_superior_agree.agree !== true && project.comment_box_provincial_superior !== null
                    ) {
