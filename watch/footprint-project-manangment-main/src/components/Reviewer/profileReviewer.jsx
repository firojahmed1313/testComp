    ...
    const getReviewersData = async () => {
      try {
        ...
        setUserDetails((prevDetails) => {
          ...
          return {
            ...prevDetails,
            name: reviewersData.data.data.name,
            email: reviewersData.data.data.email,
            mobileNumber: reviewersData.data.data.mobile,
            province: reviewersData.data.data.nameOfProvince,
          };
        });
...
export default ProfilePageReviewer;